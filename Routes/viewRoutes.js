...
router.get("/emailVerification", userController.isLoggedIn, viewController.emailVerification);
router.get("/VerificationCode", userController.isLoggedIn, viewController.verifyCode);
router.get("/Resetpassword", userController.isLoggedIn, viewController.resetCode);
